...
import { Alert, View, StyleSheet, Image, TouchableOpacity, Text, ScrollView } from 'react-native';
...
const Points = () => {
    ...
    function handledSelectItem(id: number){
                ...
                >
                    {items.map(item => (
                        <TouchableOpacity 
                            ...
                            onPress={() => handledSelectItem(item.id)} 
                            activeOpacity={0.6}
                        >
